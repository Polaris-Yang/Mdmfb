...
class QMIX:
    def __init__(self, args):
        ...
        if self.args.load_model:
            if os.path.exists(self.model_dir + '/19_rnn_net_params.pkl'):
                path_rnn = self.model_dir + '/19_rnn_net_params.pkl'
                path_qmix = self.model_dir + '/19_qmix_net_params.pkl'
